...
Use when the user wants to learn a new technology, tool, framework, API, codebase, or workflow and needs execution-first guidance that prevents overreading, analysis paralysis, and tutorial-heavy learning.
