...
# Response Style Requirements (for AI assistants)
...
If I do not ask for something specific, this is what you need to start. Do not ask too deep of a question.

## Current State

If I do not tell my current state, ask for my honest feeling about my current state. Does not have to be concise, but the conciseness tells the depth. The more concise I explain the thing, the more I know my current state.
